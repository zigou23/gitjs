// https://gist.github.com/tennc/d05f3f26417b1a22dcb33fbb7a013af6
// List of domains bind to your WorkersProxy.
const domain_list = ['https://your cloudflareWorker web/']

// Website you intended to retrieve for users.
const upstream = 'https://js web/'

// Website you intended to retrieve for users using mobile devices.
const upstream_mobile = 'https://js mobile web/'
